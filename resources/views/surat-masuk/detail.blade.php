                    ...
                    <div class="intro-y col-span-12 lg:col-span-6">
                        ...
                        <div class="intro-y box">
                            ...
                            <div
                                ...
                                <a href="{{ route('surat-masuk.edit',$surat_masuk->id_suratmasuk) }}">
                            ...
                            <div id="input" class="p-5">
                                <div class="form-inline"> <label for="horizontal-form-1" class="form-label sm:w-40">Tanggal
                                        ...
                                        value="{{ $surat_masuk->tanggalmasuk_suratmasuk }}" readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        ...
                                        type="text" class="form-control" value="{{ $surat_masuk->kode_suratmasuk }}"
                                        readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Ketegori Surat</label> <input id="horizontal-form-1"
                                        type="text" class="form-control" value="{{ $surat_masuk->tipe }}" readonly>
                                </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Nomor Surat</label> <input id="horizontal-form-1"
                                        type="text" class="form-control" value="{{ $surat_masuk->nomor_suratmasuk }}"
                                        readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Tanggal Surat</label> <input id="horizontal-form-1"
                                        type="text" class="form-control"
                                        value="{{ $surat_masuk->tanggalsurat_suratmasuk }}" readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Pengirim</label> <input id="horizontal-form-1"
                                        type="text" class="form-control"
                                        value="{{ $surat_masuk->pengirim }}" readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Kepada</label> <input id="horizontal-form-1"
                                        type="text" class="form-control"
                                        value="{{ $surat_masuk->kepada_suratmasuk }}" readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Perihal</label>
                                    <textarea id="horizontal-form-1" class="form-control" readonly> {{ $surat_masuk->perihal_suratmasuk }} </textarea>
                                </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">Operator</label> <input id="horizontal-form-1"
                                        type="text" class="form-control"
                                        value="{{ $surat_masuk->operator }}" readonly> </div>
                                <div class="form-inline mt-5"> <label for="horizontal-form-1"
                                        class="form-label sm:w-40">File</label> <a href="/storage/surat-masuk-file/{{ $surat_masuk->file_suratmasuk }}">
