...
@section('subhead')
    <title>Sistem arsip | tambah surat masuk</title>
@endsection
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="kode_suratmasuk" value="{{ old('kode_suratmasuk') }}"
                                                placeholder="Masukkan kode surat...">

                                            <!-- error message untuk title -->
                                            @error('kode_suratmasuk')
                                        ...
                                        <div class="form-group mt-4">
                                            ...
                                            <input type="text"
                                                ...
                                                name="nomor_suratmasuk" value="{{ old('nomor_suratmasuk') }}"
                                        ...
                                        <div class="form-group relative mt-4 mx-auto">
                                            ...
                                            <div class="relative mx-auto mt-1">
                                                <div
                                                    ...
                                                    value="{{ old('tanggalsurat_suratmasuk') }}">
                                            ...
                                            <div class="form-group mt-4">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="kepada_suratmasuk" value="{{ old('kepada_suratmasuk') }}"
                                            ...
                                            <div class="form-group mt-4">
                                                ...
                                                <textarea class="form-control mt-1 @error('perihal_suratmasuk') is-invalid @enderror" name="perihal_suratmasuk"
                                                    value="{{ old('perihal_suratmasuk') }}" placeholder="masukkan perihal surat..."></textarea>

                                                <!-- error message untuk title -->
                                                @error('perihal_suratmasuk')
                                                    <div class="alert alert-danger mt-2">
                                                        {{ $message }}
                                                    </div>
                                                @enderror
                                            ...
                                            <div class="form-group mt-4">
                                                <label class="font-weight-bold mt-3">Upload file</label>
                                                <input type="file"
